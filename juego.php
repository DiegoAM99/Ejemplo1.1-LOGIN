...
<div>
    ...
    <p><a id="enunciado" class="btn btn-block btn-success"></a></p>
...
<script>
  ...
  var numeroPregunta = Math.random() * listaPreguntas.legth;
  $('#enunciado').text(listaPreguntas[numeroPregunta] [1]);
  $('#r1').text(listaPreguntas[numeroPregunta] [2].click(sigue()));
  $('#r2').text(listaPreguntas[numeroPregunta] [3].click(sigue()));
  $('#r3').text(listaPreguntas[numeroPregunta] [4]).click(sigue());
  $('#r4').text(listaPreguntas[numeroPregunta] [5]).click(sigue());
  
  function sigue(){
      numeroPregunta = Math.floor(Math.random() * listaPreguntas.legth);
      $('#enunciado').text(listaPreguntas[numeroPregunta] [1]);
  $('#r1').text(listaPreguntas[numeroPregunta] [2].click(sigue()));
  $('#r2').text(listaPreguntas[numeroPregunta] [3].click(sigue()));
  $('#r3').text(listaPreguntas[numeroPregunta] [4]).click(sigue());
